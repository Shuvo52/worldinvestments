...
.wp-block-archives .select_container:hover select,
.wp-block-categories .select_container:hover select,
.widget_area .select_container:hover select,
.variations .select_container:hover select{
...
.custom.tparrows {
	background-color: {$colors['input_bd_hover']}!important;
...
.footer_widgets_wrap .wp-calendar-nav .wp-calendar-nav-prev a:before,
.footer_widgets_wrap .wp-calendar-nav .wp-calendar-nav-next a:before{
...
.scheme_self.footer .widget_product_tag_cloud a,{
	color: {$colors['text']}!important;
	background-color: {$colors['inverse_text']}!important;
}
.wp-block-tag-cloud a,
...
.scheme_self.footer .widget_tag_cloud a:hover {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link']};
}
...
.menu_footer_nav_area .sc_layouts_menu_nav > li li > a,
.menu_footer_nav_area ul li a {
	color: {$colors['alter_text']}!important;
}
.menu_footer_nav_area .sc_layouts_menu_nav > li li > a:hover{
	color: {$colors['text_link']} !important;
}
